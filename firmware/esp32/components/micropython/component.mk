...
PY_QSTR_DEFS = $(ABS_PY_SRC)/qstrdefs.h $(COMPONENT_PATH)/inc/qstrdefsport.h
QSTR_DEFS_COLLECTED = $(HEADER_BUILD)/qstrdefs.collected.h
QSTR_GEN_EXTRA_CFLAGS += -DNO_QSTR -DN_X64 -DN_X86 -DN_THUMB -DN_ARM -DN_XTENSA  $(QSTR_INCLUDE_FLAGS)
SED ?= sed
MKDIR ?= mkdir
PYTHON ?= python
CPP ?= $(CC) -E
